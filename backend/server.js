...
//Ruta de Empresas
app.get('/empresas', empresaController.getAllEmpresas); // Obtener todos las categorias
app.get('/empresas/:id', empresaController.getEmpresaById); // Obtener un artículo por ID
app.post('/empresas', empresaController.createEmpresa); // Crear un nuevo artículo
app.put('/empresas/:id', empresaController.updateEmpresa); // Actualizar un artículo
